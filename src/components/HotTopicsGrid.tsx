...
const hotTopics = [
  { emoji: '💒', name: '何太事件 · 你點睇？', count: '328 人討論中', badge: 'hot' },
  { emoji: '📱', name: '交友 app 邊個最好用？', count: '256 人討論中', badge: 'hot' },
  { emoji: '💸', name: '情人節禮物 budget 幾多？', count: '189 人討論中', badge: 'new' },
  { emoji: '🏠', name: '結婚買樓 · 香港現實', count: '412 人討論中', badge: 'hot' },
  { emoji: '👶', name: '生唔生仔？年輕一代點揀', count: '297 人討論中', badge: 'hot' },
  { emoji: '🌐', name: 'Long D 移民潮 · 異地戀點算', count: '173 人討論中', badge: 'new' },
];
      ...
      {hotTopics.map((topic) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[13.5px] font-semibold text-hearten-text whitespace-nowrap overflow-hidden text-ellipsis">
              {topic.name}
            </div>
            <div className="text-[11.5px] text-hearten-dim mt-[2px]">{topic.count}</div>
          </div>
          {topic.badge === 'hot' ? (

      ...
      {polls.map((poll, i) => (
        ...
        >
          ...
          {poll.options.map((opt, j) => (
            <div
              key={j}
              className="flex items-center gap-[10px] py-[10px] px-3 rounded-[10px] mb-[6px] relative overflow-hidden border border-hearten-border bg-[#fdf2f4] dark:bg-[#fdf2f4] light:bg-[#fff5f5] cursor-pointer transition-all duration-[0.15s] hover:border-hearten-rose"
            >
              {/* Bar */}
              <span

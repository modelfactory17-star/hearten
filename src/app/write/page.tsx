    ...
    return (
      <div className="min-h-screen bg-hearten-bg">
        <div className="sticky top-0 z-50 h-14 border-b border-hearten-border bg-hearten-bg/90 backdrop-blur flex items-center px-4">
          <button onClick={() => router.push('/')} className="flex items-center gap-1 text-hearten-muted hover:text-white transition-colors text-base">
        ...
        <div className="max-w-lg mx-auto px-4 py-20 text-center">
          ...
          <h1 className="text-xl font-bold text-white mb-2">心事已發出！</h1>
  ...
  return (
    <div className="min-h-screen bg-hearten-bg">
      ...
      <div className="sticky top-0 z-50 h-14 border-b border-hearten-border bg-hearten-bg/90 backdrop-blur flex items-center px-4 gap-4">
        <button onClick={() => router.back()} className="flex items-center gap-1 text-hearten-muted hover:text-white transition-colors text-base">
          <ArrowLeft className="w-5 h-5" />
          返回上頁
        </button>
      ...
      <div className="max-w-lg mx-auto px-4 py-8">
        <div className="bg-hearten-card border border-hearten-border rounded-2xl p-6">
          <h1 className="text-xl font-bold text-white mb-1">分享你嘅心事 💭</h1>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              maxLength={80}
              className="w-full bg-hearten-bg border border-hearten-border rounded-lg px-4 py-3 text-base text-white placeholder-hearten-muted outline-none focus:border-hearten-rose transition-colors"
            />
          ...
          <div className="mb-5">
            ...
            <textarea
              ...
              rows={8}
              className="w-full bg-hearten-bg border border-hearten-border rounded-lg px-4 py-3 text-base text-white placeholder-hearten-muted outline-none resize-none focus:border-hearten-rose transition-colors"
            />
          </div>
